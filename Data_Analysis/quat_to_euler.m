...
% rearranging processed tracker device database to python database
% add eul1 and eul2
db_pp = db;
db_pp(:,3:5) = eul2;
db_pp(:,19:21) = eul1;
...
writetable(data_person1,'sc_data_person1_tracker_deviceprocessed.csv');

data_person2 = array2table(db_pp2);
data_person2.Properties.VariableNames(1:7) = {'Time','Pitch','Roll','Yaw','X-Pos','Y-Pos','Z-Pos'};
writetable(data_person2,'sc_data_person2_tracker_deviceprocessed.csv');
end