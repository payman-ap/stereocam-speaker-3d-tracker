...
df1 = pd.read_csv(r'./data/sc4_data_person1_preprocessed.csv')
df2 = pd.read_csv(r'./data/sc4_data_person2_preprocessed.csv')

# Start the database with timestamp of tracker device
